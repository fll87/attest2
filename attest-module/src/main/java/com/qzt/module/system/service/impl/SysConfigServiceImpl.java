...
import com.qzt.common.annotation.DataSource;
...
import com.qzt.common.enums.DataSourceType;
...
public class SysConfigServiceImpl implements ISysConfigService
{
     ...
     */
    @Override
    public boolean selectEmailEnabled()
    {
        String emailEnabled = selectConfigByKey("sys.account.emailEnabled");
        if (StringUtils.isEmpty(emailEnabled))
        {
            return true;
        }
        return Convert.toBool(emailEnabled);
    }
    ...
    public void deleteConfigByIds(Long[] configIds)
    {
        for (Long configId : configIds)
        {
            ...
            {
                throw new ServiceException(SysErrorCodeConstants.CONFIG_IS_BUILTIN);
            }
     ...
     */
    @Override
    public String selectSmsTemplateByCode(String templateCode) {
        return selectConfigByKey(templateCode);
    }
