...
import com.qzt.module.system.mapper.SysDictDataMapper;
import com.qzt.module.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
    ...
    public void deleteDictTypeByIds(Long[] dictIds)
    {
        for (Long dictId : dictIds)
        {
            ...
            {
                throw new ServiceException(SysErrorCodeConstants.DICT_TYPE_HAS_CHILDREN);
            }
