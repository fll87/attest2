...
import com.qzt.module.system.domain.SysRoleMenu;
...
import com.qzt.module.system.mapper.SysRoleMenuMapper;
...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    public void checkRoleAllowed(SysRole role)
    {
        ...
        {
            throw new ServiceException(SysErrorCodeConstants.ROLE_CAN_NOT_UPDATE_SYSTEM_TYPE_ROLE);
        }
    }
    ...
    public int deleteRoleByIds(Long[] roleIds)
    {
        for (Long roleId : roleIds)
        {
            ...
            {
                throw new ServiceException(SysErrorCodeConstants.ROLE_EXITS_CHILDREN);
            }
        }
        // 删除角色与菜单关联
