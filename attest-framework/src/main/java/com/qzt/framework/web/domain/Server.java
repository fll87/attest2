package com.qzt.framework.web.domain;

import com.qzt.common.utils.Arith;
import com.qzt.common.utils.ip.IpUtils;
import com.qzt.framework.web.domain.server.*;
...
public class Server
{
     ...
     * 磁盘相关信息
     */
    private List<SystemFile> systemFiles = new LinkedList<SystemFile>();
    ...
    public void setSysFiles(List<SystemFile> systemFiles)
    {
    ...
    private void setSysFiles(OperatingSystem os)
    {
        ...
        for (OSFileStore fs : fsArray)
        {
            ...
            systemFile.setUsage(Arith.mul(Arith.div(used, total, 4), 100));
