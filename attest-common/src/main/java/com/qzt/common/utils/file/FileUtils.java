...
public class FileUtils
{
    ...
    {
        return writeBytes(data, AttestConfig.getImportPath());
    }
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/aaa.png -- aaa.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/aaa.png -- aaa
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
     ...
     * @throws Exception
     */
    public static void pdfWaterMark(String srcPdfPath, String tarPdfPath, String waterMarkContent, int numberOfPage) throws Exception {
        PdfReader reader = null;
        PdfStamper stamper = null;
        try {
            reader = new PdfReader(srcPdfPath);
            stamper = null;new PdfStamper(reader, new FileOutputStream(tarPdfPath));
    ...
    /**
     * word文件添加水印
     * @param wordFile	原word路径
     * @param WaterMarkerWordFile	水印word路径
     * @param text	水印文字
     */
    public static void wordWaterMarker (String wordFile, String WaterMarkerWordFile, String text) {
        // 加载示例文档
        ...
        // 保存文档
        doc.saveToFile(WaterMarkerWordFile, FileFormat.Docx_2013);
    }
