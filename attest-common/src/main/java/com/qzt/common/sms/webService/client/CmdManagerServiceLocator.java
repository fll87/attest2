...
public class CmdManagerServiceLocator extends org.apache.axis.client.Service
		implements CmdManagerService {
	...
	public CmdManagerServiceLocator(String wsdlLoc, QName sName)
			throws javax.xml.rpc.ServiceException {
		super(wsdlLoc, sName);
	}

	// Use to get a proxy class for CmdManager
	private String CmdManager_address = "http://localhost:8080/hotelservice1.6/services/CmdManager";
	...
	public CmdManager getCmdManager(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			CmdManagerSoapBindingStub _stub = new CmdManagerSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (CmdManager.class.isAssignableFrom(serviceEndpointInterface)) {
				CmdManagerSoapBindingStub _stub = new CmdManagerSoapBindingStub(
						new java.net.URL(CmdManager_address), this);
				_stub.setPortName(getCmdManagerWSDDServiceName());
				return _stub;
			}
		} catch (Throwable t) {
	...
	public QName getServiceName() {
		return new QName("http://server.webService.qzt.com", "CmdManagerService");
	}
	...
	public java.util.Iterator<QName> getPorts() {
		if (ports == null) {
			...
			ports.add(new QName("http://server.webService.qzt.com", "CmdManager"));
		}
