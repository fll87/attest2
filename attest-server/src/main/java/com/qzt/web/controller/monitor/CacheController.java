...
import com.qzt.module.system.domain.SysCache;
...
public class CacheController
{
    ...
    private final static List<SysCache> caches = new ArrayList<SysCache>();
    {
        ...
        caches.add(new SysCache(CacheConstants.CAPTCHA_CODE_KEY, "图形验证码"));
        caches.add(new SysCache(CacheConstants.SMS_CODE_KEY, "手机验证码"));
